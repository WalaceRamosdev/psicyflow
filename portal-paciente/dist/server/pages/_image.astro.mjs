...
import { r as resolveSrc, d as isRemoteImage, i as isCoreRemotePath, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemoteAllowed } from '../chunks/astro/assets-service_Ck1weR6C.mjs';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_Ck1weR6C.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "C:/Users/HP/Documents/projetos alpha code/app para psicólogos - react native/portal-paciente/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/HP/Documents/projetos alpha code/app para psicólogos - react native/portal-paciente/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///C:/Users/HP/Documents/projetos%20alpha%20code/app%20para%20psic%C3%B3logos%20-%20react%20native/portal-paciente/dist/client/");
